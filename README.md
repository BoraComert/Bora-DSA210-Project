...
My goal is to understand how weather patterns such as precipitation ,temperature and humidity interact with foreign visitor numbers and if there is a correlation exists.
